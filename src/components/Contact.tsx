...
const contactInfo = [
  {
    icon: 'Phone',
    label: 'Phone',
    value: '+1 (973) 576-8963',
    href: 'tel:+19735768963',
  },
  {
    icon: 'Mail',
    label: 'Email',
    value: 'info@adsolutionllc.net',
    href: 'mailto:info@adsolutionllc.net',
  },
  {
    icon: 'MapPin',
    label: 'Office',
    value: 'BEVERWYCK RD Parsippany, NJ 07054',
    href: '#map',
  },
  {
    icon: 'Linkedin',
    label: 'LinkedIn',
    value: 'linkedin.com/company/ad-solutionllc',
    href: 'https://www.linkedin.com/company/ad-solutionit/',
  },
];
...
export function Contact() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      inquiry_type:
        (data.get('inquiry_type') as string) || 'general',
    ...
    // Make sure SMS consent was given
    if (!payload.sms_consent) {
      setStatus('error');
      setErrorMsg(
        'Please agree to receive text communications before submitting the form.'
      );
      return;
    }
  ...
  return (
    <section
      id="contact"
      className="relative py-20 sm:py-28 bg-navy-900"
    >
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="reveal mt-4 text-base leading-relaxed text-navy-200 text-pretty">
              Tell us what you need — talent, a career move, or a
            ...
            <div
              id="map"
              className="reveal mt-6 overflow-hidden rounded-2xl ring-1 ring-inset ring-white/10"
            >
              <iframe
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-start gap-3">
                      <input
                        ...
                        type="checkbox"
                        required
                        className="mt-1 h-4 w-4 shrink-0 rounded border-navy-300 text-brand-600 focus:ring-brand-500"
                      />

                      <label
                        htmlFor="sms_consent"
                        className="text-xs leading-relaxed text-navy-600"
                      >
                  ...
                  <p className="text-center text-xs text-navy-400">
                    ...
                    your inquiry. We never share your information.
                  </p>
